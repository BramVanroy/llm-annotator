...
- localize cultural and regional properties to those relevant to Europe, e.g. dollars should become euros, the imperial system should be converted to metric, and instead of a decimal point we use a a decimal comma, e.g. `10,42`. As a consequence of certain conversions (especially for the metric system!) you will have to make corrections to the actual contents to make sure the math checks out;
