...
- use correct scientific and mathematical terminology in Dutch;
...
- keep inline formulas, display math, variable names, and LaTeX commands exactly as written unless localization is needed - then adapt the content;
- keep all code blocks, tables, LaTeX environments, and inline backticks;
...
- localize cultural and regional properties to those relevant to Europe, e.g. dollars should become euros, the imperial system should be converted to metric, and instead of a decimal point we use a a decimal comma, e.g. `10,42`. As a consequence of certain conversions (especially for the metric system!) you will have to make corrections to the actual contents to make sure the math checks out and is deterministically correct.

Follow the requirements above strictly and translate the following text to fluent Dutch. Output ONLY the translated Dutch text immediately.
